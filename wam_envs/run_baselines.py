...
def train(args, extra_args):
    ...
    action_interface_kwargs = ['action_dim', 'NHT_path']
    env_kwargs = {}
    for kwarg in extra_args:
        if kwarg in action_interface_kwargs:
            env_kwargs.update({kwarg:extra_args[kwarg]})

    # print('\nenv kwargs\n')
    # print(env_kwargs)
    # print('\nend env kwargs\n')

    alg_kwargs['env_kwargs'] = env_kwargs
    # print('\nenv kwargs\n')
    # env_kwargs = {}
    # for kwarg in extra_args:
    #     print(kwarg)
...
def get_alg_module(alg, submodule=None):
    ...
    try:
        ...
        if alg == 'her':
            alg_module = import_module('wam_envs.baselines_hack.her')
        else:
