'''
Copied from baselines.her.experiment folder.

Only difference is that we pass env_kwargs to gym.make so that we can control the size of the action space
'''
...
def prepare_params(kwargs):
    ...
    def make_env(subrank=None):
        env = gym.make(env_name,**kwargs['env_kwargs'])
